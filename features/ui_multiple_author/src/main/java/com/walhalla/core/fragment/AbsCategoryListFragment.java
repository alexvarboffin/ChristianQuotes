...
import com.walhalla.uimultiple.R;
import com.walhalla.uimultiple.databinding.FragmentSearchListBinding;
...
public abstract class AbsCategoryListFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        alphabetInj(useAlphaSectionRes());
...
//        });
    ...
    private void alphabetInj(boolean alphabet) {
        if (alphabet) {

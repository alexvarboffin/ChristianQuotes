...
import static com.christianquotes.inspirefaith.activity.Pagin.TAG_DIVIDER;
...
import com.christianquotes.inspirefaith.MyApp;
import com.christianquotes.inspirefaith.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity
    ...
    private void loadHomeFragment(String currentTag) {
        ...
        boolean current = aa != null;
        if (current && aa.isVisible()) {
            //bsf
            try {
...
//        }
        ...
        mThread = new Thread(() -> {
            try {
                ...
                mHandler.post(() -> {
                    pagin.replaceFragmentWithPopBackStack(currentTag);
                });
                //mThread.interrupt();
            } catch (InterruptedException e) {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pagin = new Pagin(this);
        binding = ActivityMainBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        content = findViewById(R.id.bottom_button);
...
//                    .commit();
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, home, TypeNavItem.TAG_SHOW_CATEGORY)
                    .commit();
        } else {
...
//    return true;
            ...
            return true;
//} else if (itemId == R.id.action_more_app_01) {
...
//        replaceFragment(fragment);
        ...
        replaceFragmentWithBack(fr, CURRENT_TAG);
    }
...
//                //AbstractStatusListFragment->save
//            } else {
...
//    }
    public void replaceFragmentWithBack(Fragment fragment, String fragmentTag) {
...
//                        return true;
        ...
        if (!found) {
            int rawId = pagin.getCategoryId(itemItemId);
            if (rawId > 0) {
...
//                        };
                ...
                navItemIndex = 0;
                CURRENT_TAG = TypeNavItem.__TAG_CATEGORY_LIST + TAG_DIVIDER + rawId;
            } else {
                navItemIndex = 1;
            }
        }

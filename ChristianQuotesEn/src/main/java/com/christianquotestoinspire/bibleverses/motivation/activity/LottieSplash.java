...
import com.christianquotestoinspire.bibleverses.motivation.Cst;
import com.christianquotestoinspire.bibleverses.motivation.NetUtils;
import com.christianquotestoinspire.bibleverses.motivation.databinding.ActivitySplashBinding;
...
//    private void tvProgressAnimation0(float startY, float dim, String text, boolean b) {
...
//                if (b) {
//                    tvProgressAnimation(startY, dim, binding.textVer, R.string.launcher_progress_title_second, false);
//                }
//            }
//
//            @Override
...
//    }
    ...
    //    private void tvProgressAnimation(float startY, float dim, TextView tvProgress, int text, boolean b) {
//        tvProgress.setText(text);
//
//        //launcher_progress_title_second
//        //launcher_progress_title_third
...
//            if (pref.noneMuted()) {
//                pref.fraudCheck(this, new String[]{
//                        CheckTypeKey0.CH_ISPROBABLYANEMULATOR,
//                        CheckTypeKey0.CH_FORFRAUDORPHISHING,
//                        CheckTypeKey0.CH_ISSIMSUPPORT,
//                        CheckTypeKey0.CH_USEVPN,
//                        CheckTypeKey0.CH_GETLOCALIPADDRESS,
//                });
//                pref.setMute("true");
//            }
//        }

        //binding.textName.setText("@@@@" + pref.getAllFraudCheck0());
...
//        if (Cst.SPLASH_SCREEN_ENABLED) {
//            if (Cst.CHECK_CONNECTION) {
//                if (NetUtils.isOnline(this)) {
//                    //if (loadStatus) {
////            Intent intent = new Intent(this, BaseActivity.class).setFlags(COOL_FLAGH);
...
//        }
    ...
    private void createTimer() {
        ...
        countDownTimer = new CountDownTimer(Cst.COUNTER_TIME_MS, 1000) {
            @Override

...
import com.google.android.justintrain_oraritreni.db.sqliteAsset.AssetSQLiteOpenHelper;
...
//                            .openHelperFactory(configuration -> new AssetSQLiteOpenHelper(
//                                    //configuration, context, null,
//                                    /*configuration.version*/ Constants.version,
//                                    /*configuration.errorHandler*/new DatabaseErrorHandler() {
//                                @Override
//                                public void onCorruption(SQLiteDatabase dbObj) {
//                                    DLog.d("@@@@" + dbObj.getVersion());
//                                }
//                            }, configuration.callback))

                            .openHelperFactory(new AssetSQLiteOpenHelperFactory(Constants.version))
